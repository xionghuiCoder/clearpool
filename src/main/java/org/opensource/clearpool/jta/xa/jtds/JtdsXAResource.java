...
public class JtdsXAResource implements XAResource {
	...
	public void commit(Xid xid, boolean commit) throws XAException {
		XASupport.xa_commit(this.connection,
				this.xaConnection.getXAConnectionID(), xid, commit);
	}

	@Override
	public void end(Xid xid, int flags) throws XAException {
		XASupport.xa_end(this.connection,
				this.xaConnection.getXAConnectionID(), xid, flags);
	}

	@Override
	public void forget(Xid xid) throws XAException {
		XASupport.xa_forget(this.connection,
				this.xaConnection.getXAConnectionID(), xid);
	}
	...
	public int prepare(Xid xid) throws XAException {
		return XASupport.xa_prepare(this.connection,
				this.xaConnection.getXAConnectionID(), xid);
	}

	@Override
	public Xid[] recover(int flags) throws XAException {
		return XASupport.xa_recover(this.connection,
				this.xaConnection.getXAConnectionID(), flags);
	}

	@Override
	public void rollback(Xid xid) throws XAException {
		XASupport.xa_rollback(this.connection,
				this.xaConnection.getXAConnectionID(), xid);
	}
	...
	public void start(Xid xid, int flags) throws XAException {
		XASupport.xa_start(this.connection,
				this.xaConnection.getXAConnectionID(), xid, flags);
	}
}
