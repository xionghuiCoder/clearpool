...
/**
 * This is a abstract factory,it is used to build product tree,such as dataSource and
 * pooledConnection.
 * 
 * @author xionghui
 * @date 16.08.2014
...
public abstract class DataSourceAbstractFactory {
  ...
  public abstract PooledConnection createPooledConnection(ConnectionProxy conProxy);
}
